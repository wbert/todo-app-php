...
<body>
    <div class="container d-flex justify-content-center mt-5">
      <div class="col-6">
        ...
        <div class="row">
          <a href="add_todo.php" class="btn btn-outline-dark btn-sm">Add Todo</a>
        </div>
        <?php
...
?>
        <?php if($res->num_rows > 0): ?>
            ...
            <div class="row border rounded p-3 my-3">
                ...
                <div class="row my-1">
                    <a href="update_todo.php?id=<?=$row['id'];?>" class="btn btn-sm btn-warning">Edit</a>
                </div>
                <div class="row my-1">
    ...
    <a href="../handlers/logout_handler.php" class="btn btn-danger btn-sm position-fixed bottom-0 start-0 mb-3 ms-3">Logout</a>
